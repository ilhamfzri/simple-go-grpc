...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=simple.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e,
	...
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c,
	...
	0x15, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: simple.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: simple.pcbook.Storage
	(*Memory)(nil),      // 2: simple.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: simple.pcbook.Storage.driver:type_name -> simple.pcbook.Storage.Driver
	2, // 1: simple.pcbook.Storage.memory:type_name -> simple.pcbook.Memory
