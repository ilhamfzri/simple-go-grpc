...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=simple.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x0b, 0x32, 0x20, 0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f,
	...
	0x2e, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x04, 0x4f, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x42, 0x05, 0x5a, 0x03, 0x70, 0x62, 0x2f, 0x62, 0x06,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: simple.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: simple.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: simple.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: simple.pcbook.Screen.resolution:type_name -> simple.pcbook.Screen.Resolution
	0, // 1: simple.pcbook.Screen.panel:type_name -> simple.pcbook.Screen.Panel
